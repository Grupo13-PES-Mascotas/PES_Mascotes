...
import org.pesmypetcare.usermanagerlib.datacontainers.pet.MedicationData;
...
public class MedicationManagerAdapter implements MedicationManagerService {
    ...
    public void createMedication(User user, Pet pet, Medication medication) throws MedicationAlreadyExistingException,
        ...
        org.pesmypetcare.usermanagerlib.datacontainers.pet.Medication libraryMedication =
            new org.pesmypetcare.usermanagerlib.datacontainers.pet.Medication(medication.getMedicationDate().toString(),
    ...
    public List<Medication> findMedicationsByPet(User user, Pet pet) throws ExecutionException, InterruptedException {
        ...
        List<org.pesmypetcare.usermanagerlib.datacontainers.pet.Medication> serverMedications = new ArrayList<>();
        serverMedications = ServiceLocator.getInstance().getMedicationManagerClient().getAllMedicationData(accessToken,
            owner, petName);
        for (org.pesmypetcare.usermanagerlib.datacontainers.pet.Medication serverMedication : serverMedications) {
